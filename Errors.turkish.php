...
$txt['no_password'] = 'Şifre bölümünü boş bıraktınız.';
...
$txt['not_approved_topic'] = 'Bu konu henüz onaylanmadı.';
...
$txt['ran_out_of_space'] = 'Dosyanın yükleneceği dizin doludur. Lütfen daha küçük bir dosya deneyin veya yöneticiler ile iletişime geçin.';
...
$txt['session_timeout'] = 'İletinizi yollarken oturumunuz aşıma uğradı. Lütfen geri gidip tekrar deneyin.';
$txt['session_verify_fail'] = 'Oturum doğrulaması başarısız oldu ya da süreniz doldu. Tekrar giriş yapmayı deneyin.';
...
$txt['cannot_remove_own'] = 'Buradaki kendi konularınızı silemezsiniz.';
...
$txt['cannot_pin_topic'] = 'Bu konuyu sabitlemeye yetkiniz yok.';
...
$txt['cannot_mark_any_notify'] = 'Haber almak için yetkiniz yok.';
$txt['cannot_mark_notify'] = 'Konudan haberdar olmak için izniniz yok.';
$txt['cannot_merge_any'] = 'Konuları seçili bölümlerde birleştirme yetkiniz yok. ';
$txt['cannot_merge_moved'] = '"Konu Taşındı" Bildirimlerini birleştiremezsiniz';
...
$txt['cannot_modify_mod_post'] = 'Üzgünüz daha önce bir moderatör tarafından düzenlenmiş bir yazıyı düzenlemek için yetkiniz yok';
...
$txt['cannot_profile_view_own'] = 'Kendi profilinizi görüntüleyebilme yetkiniz yok. ';
$txt['cannot_profile_view_any'] = 'Bu profili görüntüleyebilme yetkiniz yok.';
$txt['cannot_delete_own'] = 'Kendi iletinizi silmek için yetkiniz yok.';
...
$txt['cannot_send_topic'] = 'Yöneticiler bu bölüme ileti gönderilmesine izin vermiyor.';
...
$txt['profile_error_password_short'] = 'Şifreniz en az %1$d karakter uzunluğunda olmalı.';
