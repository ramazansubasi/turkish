...
$txt['signature'] = 'İmza';
$txt['profile_posts'] = 'İletiler';
$txt['change_profile'] = 'Profili değiştir';
$txt['delete_user'] = 'Kullanıcıyı sil';
$txt['current_status'] = 'Durum:';
$txt['personal_text'] = 'Kişisel İleti';
$txt['personal_picture'] = 'Kişisel Resim';
$txt['no_avatar'] = 'Avatar yok';
$txt['choose_avatar_gallery'] = 'Galeriden avatar seçin';
$txt['picture_text'] = 'Resim/Metin';
$txt['reset_form'] = 'Formu Sıfırla';
$txt['preferred_language'] = 'Tercih Edilen Dil';
$txt['age'] = 'Yaş';
$txt['no_pic'] = '(resim yok)';
$txt['latest_posts'] = 'Son gönderdiği iletiler: ';
$txt['additional_info'] = 'Ek Bilgi';
$txt['avatar_by_url'] = 'Avatarınızın URL adresini belirtin. (Örn: <em>http://www.site.org/avatar.gif</em>)';
...
$txt['include_website_url'] = 'Aşağıda girmiş olduğunuz web sitesinin başlığı.';
$txt['complete_url'] = 'Bu tam bir adres olmalıdır.';
...
$txt['digits_only'] = '\'İleti Sayısı\' sadece sayısal değer içerebilir.';
...
$txt['time_zone'] = 'Zaman Dilimi';
$txt['my_time_offset'] = 'Time Offset';
$txt['timeoffset_autodetect'] = '(otomatik algıla)';

$txt['secret_question'] = 'Gizli Soru';
$txt['secret_desc'] = 'Şifrenizi hatırlatmaya yarar. Buraya yanıtını <strong>sadece</strong> sizin bildiğiniz bir soru ve cevap girin.';
$txt['secret_desc2'] = 'Dikkatli seçin, başkası cevabınızı tahmin edebilir!';
$txt['secret_answer'] = 'Cevap';
$txt['secret_ask'] = 'Gizli sorumu sor';
$txt['cant_retrieve'] = 'Şifrenizi öğrenemezsiniz, ama e-posta adresinize gönderilecek bağlantı ile yeni bir şifre ayarlayabilirsiniz. Eğer gizli sorunuza doğru cevabı verebilirseniz yeni bir şifre almanızda mümkün olur.';
...
$txt['notify_send_body'] = 'Duyuru gönderilirken, konunun içeriğini duyuru ile birlikte e-posta adresime gönder.';

$txt['notifications_topics'] = 'Haber edilmeyi istediğiniz konular';
$txt['notifications_topics_list'] = 'Şu konulara atılan ileti olduğu zaman haberdar edileceksiniz.';
...
$txt['notifications_boards_list'] = 'Şu odalara açılan yeni konular olduğu zaman haberdar edileceksiniz';
$txt['notifications_boards_none'] = 'Şu anda herhangi bir bölümden haberdar edilmiyorsunuz.';
$txt['notifications_boards_howto'] = 'Herhangi bir bölüme konu açıldığında haberdar olmayı istediğiniz zaman; bölüm içindeyken &quot;haberdar et&quot; bağlantısına tıklamanız yeterlidir.';
...
$txt['statPanel_timeOfDay'] = 'Günün Saatleri';
...
$txt['deleteAccount_all_posts'] = 'Tüm iletilerini';
$txt['deleteAccount_topics'] = 'Konularını ve iletilerini';
...
$txt['editBuddyIgnoreLists'] = 'Kişilerim / Engelli Listesi';
$txt['editBuddies'] = 'Kişilerim Listesini Düzenle';
...
$txt['forumProfile_info'] = 'Kişisel bilgilerinizi bu sayfadan düzenleyebilirsiniz. Bu bilgiler {forum_name_safe} adı doğrultusunda gösterilecektir. Eğer bazı kişisel bilgilerinizi paylaşmak istemiyorsanız, ilgili alanı boş bırakın - bu bölümdeki hiçbir alan zorunlu değildir.';
$txt['options'] = 'Görünüm ve Tasarım';
$txt['options_info'] = 'Bu bölüm forum görünüşünü kişisel tercihlerinize göre ayarlamanızı sağlar.';
$txt['notifications_all'] = 'Notifications';
$txt['notifications_general'] = 'Genel';
$txt['notifications_posts'] = 'Konular &amp; iletiler';
$txt['notification_info'] = 'Yeni konulardan ve mesajlardan bu bölüm yardımı ile haberdar edilebilirsiniz. Haberdar olmayı seçtiğiniz konu ve bölüm listenizi görebilirsiniz';
$txt['groupmembership'] = 'Grup Üyeliği';
$txt['groupMembership_info'] = 'Bu bölümü kullanarak üye olduğunuz grupları değiştirebilirsiniz.';
$txt['pmprefs'] = 'Kişisel İletiler';
$txt['ignoreboards'] = 'Yoksayılan Bölümler';
$txt['ignoreboards_info'] = 'Bu sayfa belli bölümleri yoksaymanızı sağlar.  Bir bölüm yoksayıldığında anasayfada, yeni iletiler barındırdığına dair resim gözükmez.  Ayrıca "okunmamış iletiler" arama bağlantısını kullandığınızda yoksayılmış bölümlerin içerdiği iletiler gösterilmezler.  "Okunmamış yanıtlar" bağlantısı kullanıldığında ise bölüm yoksayılmış ise bile iletiler göserilecektir.';

$txt['manage_account'] = 'Hesap Ayarları';
$txt['deleteAccount'] = 'Hesabı Sil';
...
$txt['errors_from_ip'] = 'IP\'nin hata iletileri: %1$s';
...
$txt['members_from_ip'] = 'Bu IP\'yi kullanan üyeler: %1$s';
$txt['members_in_range'] = 'Aynı kişi olabileceği tahmin edilen üyeler';
$txt['messages_from_ip'] = 'Bu IP\'den gönderilenler: %1$s';
...
$txt['no_errors_from_ip'] = 'Bu IP adresine ait hata iletisi yok.';
...
$txt['avatar_will_upload'] = 'Avatarınızı yükleyin';
...
$txt['no_reminder_email'] = 'Hatırlatma e-postası gönderilemedi.<br>Kimlik doğrulama detaylarını sormak için <a href="%1$s">yönetici</a>\'ye eposta gönder';
...
$txt['registration_not_approved'] = 'Üzgünüm, bu hesap henüz onaylanmadı. Eğer e-posta adresinizi değiştirmek istiyorsanız lütfen <a href="%1$s">tıklayın</a>.';
$txt['registration_not_activated'] = 'Üzgünüm, bu hesap henüz aktifleştirilmedi. Eğer aktivasyon e-postasını tekrar göndermek istiyorsanız lütfen <a href="%1$s">tıklayın</a>.';

$txt['primary_membergroup'] = 'Birincil Üye Grubu';
$txt['additional_membergroups'] = 'Ek Üye Grupları';
...
$txt['hide_avatars'] = 'Diğer kullanıcıların avatarlarını gösterme.';
$txt['hide_signatures'] = 'Diğer kullanıcıların imzalarını gösterme.';
...
$txt['display_quick_reply'] = 'İletilerde hızlı yanıt bölümünü';
$txt['display_quick_reply1'] = 'gösterme';
$txt['display_quick_reply2'] = 'kapalı olarak göster';
$txt['display_quick_reply3'] = 'açık olarak göster';

$txt['whois_title'] = 'Bu %1$s IP adresini bir \'whois-server\' kullanarak incele:';
...
$txt['show_attach_filename'] = 'Dosya';
...
$txt['showPermissions_permission'] = 'İzinler (izni olmayan işlemlerin <del>üstü çizilidir</del>)';
...
$txt['showPermissions_global'] = 'Tüm Forum';
...
$txt['list_type'] = 'Türü';
$txt['list_name'] = 'İsim';
$txt['list_visibility'] = 'Bunu kimler görebilir?';
$txt['list_everyone'] = 'Herkes|Herkes bu kişi listesini ve üyelerini görebilecek.';
...
$txt['ignore_add'] = 'Yoksayılanlara ekle';
$txt['ignore_remove'] = 'Yoksayılanlardan Kaldır';
...
$txt['profile_infractions'] = 'Uyarılar';
...
$txt['infraction_state_active'] = 'Aktif';
$txt['infraction_state_expired'] = 'Süresi Doldu';
$txt['infraction_state_revoked'] = 'İptal';
...
$txt['revoke'] = 'Revoke';
$txt['infraction_revoked_by'] = 'İptal eden:';
$txt['infraction_revoked_on'] = 'İptal tarihi:';
...
$txt['tracking'] = 'Kullanıcı Takibi';
$txt['tracking_description'] = 'Bu bölüm kullanıcı tarafından gerçekeleştirilmiş bazı işlemleri görüntülemenize ve bu kullanıcıya ait IP adresleri hakkında bilgi toplamanıza olanak tanır.';

$txt['trackReported'] = 'Rapor Edilmiş İletiler';
...
$txt['trackEdit_action_id_group'] = 'Öncelikli Üye grubu';
...
$txt['totalTimeLogged_d'] = ' gün, ';
$txt['totalTimeLogged_h'] = ' saat ve';
$txt['totalTimeLogged_m'] = ' dakika.';
